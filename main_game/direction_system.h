...
public:
	...
	void set_direction_from_8(const Vector2f move_offset, const long long elapsed_time);
	void set_direction_from_12(const Vector2f move_offset, const long long elapsed_time);
