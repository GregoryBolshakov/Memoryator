...
public:
	...
	Vector2f getCurrentDot() const { return currentDot; }
	...
	Vector2f newSlippingPositionForDotsAdjusted(Vector2f position, Vector2f motionVector, float speed, long long elapsedTime) const;	
